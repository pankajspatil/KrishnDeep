...
<h2 align="center">Visits Report</h2>
...
if(!page1.equals("")){
	...
	LinkedHashMap<String, String> revenueMap = reports.getVisitCount(fromDate, toDate, reportType,sessionModel);
	...
	if(revenueMap.size() > 0){
		...
		String chartString = "<chart caption='Visits Report' subcaption='' xaxisname='Period' yaxisname='Sales' numberprefix='' "+
